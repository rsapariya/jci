              ...
              children: [
                Row(
                  children: [
                    CircleAvatar(
                      backgroundImage:
                      NetworkImage(getdata.read('National')['image']),
                      radius: 40,
                    ),
                    SizedBox(
                      width: 10,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          width: Get.width / 1.8,
                          child: Text(
                            getdata.read('National')['Position'],
                            style: GoogleFonts.poppins(fontSize: 18),
                          ),
                        ),
                      ],
                ...
                Row(
                  children: [
                    ...
                    SizedBox(
                      width: Get.width / 1.5,
                      child: Text(
                        getdata.read('National')['location'],
                        style: GoogleFonts.poppins(fontSize: 18),
                      ),
                    ),
                  ],
